...
<style type="text/css">
	...
	.homepage .section .box1:hover,.homepage .section .box5:hover{
...
.homepage .section .box1 h4,.homepage .section .box5 h4{
...
.homepage .section .box1 h4:after,.homepage .section .box5 h4:after {
...
.homepage .section .box1 p,.homepage .section .box5 p{
...
.homepage .section .box1 p.border1:after,.homepage .section .box5 p.border1:after{
...
Search and filtering options allow buyers to find the car they want faster on any device.</p>
            		<p class="border1">Always know you car's Towing Capacity<br>
